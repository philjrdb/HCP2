...
for v = 1:n_var
  ...
  HCPsum.([ValInf_vars{v} '_PunB2']) = mean(HCPsum.(ValInf_vars{v})(:,pun2_blocks),2);
  HCPsum.([ValInf_vars{v} '_PunBPunB2ratio']) = HCPsum.([ValInf_vars{v} '_PunB2'])./...
    (HCPsum.([ValInf_vars{v} '_PunB'])+HCPsum.([ValInf_vars{v} '_PunB2']));
...
for v = 1:n_var
  ...
  HCPsum.([HCP_parameters.BinLabels{v} '_Time_PunB2']) = sum(BinTime(v:13:end,pun2_blocks),2);
  ...
  HCPsum.([HCP_parameters.BinLabels{v} '_PunClicks_PunB2']) = sum(BinPunClicks(v:13:end,pun2_blocks),2);
  HCPsum.([HCP_parameters.BinLabels{v} '_PunRate_PunB2']) = HCPsum.([HCP_parameters.BinLabels{v} '_PunClicks_PunB2'])...
    ./HCPsum.([HCP_parameters.BinLabels{v} '_Time_PunB2']);
  ...
  HCPsum.([HCP_parameters.BinLabels{v} '_UnpRate_PunB']) = HCPsum.([HCP_parameters.BinLabels{v} '_UnpClicks_PunB'])...
    ./HCPsum.([HCP_parameters.BinLabels{v} '_Time_PunB']);
  HCPsum.([HCP_parameters.BinLabels{v} '_UnpClicks_PunB2']) = sum(BinUnpClicks(v:13:end,pun2_blocks),2);
  HCPsum.([HCP_parameters.BinLabels{v} '_UnpRate_PunB2']) = HCPsum.([HCP_parameters.BinLabels{v} '_UnpClicks_PunB2'])...
    ./HCPsum.([HCP_parameters.BinLabels{v} '_Time_PunB2']);
  ...
  HCPsum.([HCP_parameters.BinLabels{v} '_ShieldRate_PunB']) = HCPsum.([HCP_parameters.BinLabels{v} '_ShieldClicks_PunB'])...
    ./HCPsum.([HCP_parameters.BinLabels{v} '_Time_PunB']);
  HCPsum.([HCP_parameters.BinLabels{v} '_ShieldClicks_PunB2']) = sum(BinShieldClicks(v:13:end,pun2_blocks),2);
  HCPsum.([HCP_parameters.BinLabels{v} '_ShieldRate_PunB2']) = HCPsum.([HCP_parameters.BinLabels{v} '_ShieldClicks_PunB2'])...
    ./HCPsum.([HCP_parameters.BinLabels{v} '_Time_PunB2']);

  HCPsum.([HCP_parameters.BinLabels{v} '_PunRate_PunBPunB2ratio']) = HCPsum.([HCP_parameters.BinLabels{v} '_PunRate_PunB2'])...
    ./(HCPsum.([HCP_parameters.BinLabels{v} '_PunRate_PunB'])+HCPsum.([HCP_parameters.BinLabels{v} '_PunRate_PunB2']));

  HCPsum.([HCP_parameters.BinLabels{v} '_UnpRate_PunBPunB2ratio']) = HCPsum.([HCP_parameters.BinLabels{v} '_UnpRate_PunB2'])...
    ./(HCPsum.([HCP_parameters.BinLabels{v} '_UnpRate_PunB'])+HCPsum.([HCP_parameters.BinLabels{v} '_UnpRate_PunB2']));
  ...
  if v == 1 % ITI for UnpB + PunB:UnpB ratio
    ...
    HCPsum.([HCP_parameters.BinLabels{v} '_ITIratio_Pun_PunB2']) = HCPsum.([HCP_parameters.BinLabels{v} '_PunRate_PunB2'])./...
      (HCPsum.([HCP_parameters.BinLabels{v} '_PunRate_PunB2']) + HCPsum.ITI_PunRate_PunB2);
    HCPsum.([HCP_parameters.BinLabels{v} '_ITIratio_Unp_PunB2']) = HCPsum.([HCP_parameters.BinLabels{v} '_UnpRate_PunB2'])./...
      (HCPsum.([HCP_parameters.BinLabels{v} '_UnpRate_PunB2']) + HCPsum.ITI_UnpRate_PunB2);
    HCPsum.([HCP_parameters.BinLabels{v} '_ITIratio_Both_PunB2']) = ...
      (HCPsum.([HCP_parameters.BinLabels{v} '_PunRate_PunB2'])+HCPsum.([HCP_parameters.BinLabels{v} '_UnpRate_PunB2']))./...
      (HCPsum.([HCP_parameters.BinLabels{v} '_UnpRate_PunB2'])+HCPsum.([HCP_parameters.BinLabels{v} '_PunRate_PunB2'])...
      + HCPsum.ITI_PunRate_PunB2 + HCPsum.ITI_UnpRate_PunB2);  
  end
...
HCPsum.Pref_PunB2 = mean(HCPsum.Pref(:,pun2_blocks),2);
HCPsum.Pref_PunUnpBratio = HCPsum.Pref_PunB./(HCPsum.Pref_UnpB+HCPsum.Pref_PunB);
HCPsum.Pref_PunBPunB2ratio = HCPsum.Pref_PunB2./(HCPsum.Pref_PunB+HCPsum.Pref_PunB2);
...
HCPsum.PrefVal_PunB2 = mean(HCPsum.PrefVal(:,pun2_blocks),2);
HCPsum.PrefVal_PunUnpBratio = HCPsum.PrefVal_PunB./(HCPsum.PrefVal_UnpB+HCPsum.PrefVal_PunB);
HCPsum.PrefVal_PunBPunB2ratio = HCPsum.PrefVal_PunB2./(HCPsum.PrefVal_PunB2+HCPsum.PrefVal_PunB);
...
HCPsum.PrefRewInf_PunB2 = mean(HCPsum.PrefRewInf(:,pun2_blocks),2);
HCPsum.PrefRewInf_PunUnpBratio = HCPsum.PrefRewInf_PunB./(HCPsum.PrefRewInf_UnpB+HCPsum.PrefRewInf_PunB);
HCPsum.PrefRewInf_PunBPunB2ratio = HCPsum.PrefRewInf_PunB2./(HCPsum.PrefRewInf_PunB2+HCPsum.PrefRewInf_PunB);
...
HCPsum.PrefRewInfconf_PunB2 = mean(HCPsum.PrefRewInfconf(:,pun2_blocks),2);
HCPsum.PrefRewInfconf_PunUnpBratio = HCPsum.PrefRewInfconf_PunB./(HCPsum.PrefRewInfconf_UnpB+HCPsum.PrefRewInfconf_PunB);
HCPsum.PrefRewInfconf_PunBPunB2ratio = HCPsum.PrefRewInfconf_PunB2./(HCPsum.PrefRewInfconf_PunB2+HCPsum.PrefRewInfconf_PunB);
...
HCPsum.PrefPAtkInf_PunB2 = mean(HCPsum.PrefPAtkInf(:,pun2_blocks),2);
...
HCPsum.pcPunShldAv_PunB2 = sum(HCPsum.nPunShldAv(:,pun2_blocks),2)./sum(HCPsum.nPunShips(:,pun2_blocks),2);
HCPsum.pcPunShldTaken_PunB2 = sum(HCPsum.nPunShldTaken(:,pun2_blocks),2)./sum(HCPsum.nPunShldAv(:,pun2_blocks),2);
HCPsum.PunShldRT_PunB2 = sum((HCPsum.PunShldRT(:,pun2_blocks).*HCPsum.nPunShldTaken(:,pun2_blocks)),2,'omitnan')...
  ./sum(HCPsum.nPunShldTaken(:,pun2_blocks),2);
...
HCPsum.pcUnpShldAv_PunB2 = sum(HCPsum.nUnpShldAv(:,pun2_blocks),2)./sum(HCPsum.nUnpShips(:,pun2_blocks),2);
HCPsum.pcUnpShldTaken_PunB2 = sum(HCPsum.nUnpShldTaken(:,pun2_blocks),2)./sum(HCPsum.nUnpShldAv(:,pun2_blocks),2);
HCPsum.UnpShldRT_PunB2 = mean((HCPsum.UnpShldRT(:,pun2_blocks).*HCPsum.nUnpShldTaken(:,pun2_blocks)),2,'omitnan')...
  ./sum(HCPsum.nUnpShldTaken(:,pun2_blocks),2);
...
HCPsum.PunP_AtkInfEst_cap = HCPsum.PunP_AtkInfEst;
HCPsum.PunP_AtkInfEst_cap(HCPsum.PunP_AtkInfEst_cap>100) = 100;
HCPsum.UnpP_AtkInfEst_cap = HCPsum.UnpP_AtkInfEst;
HCPsum.UnpP_AtkInfEst_cap(HCPsum.UnpP_AtkInfEst>100) = 100;
...
for n = 1:n_groups
  ...
  incl_idx = ismember(vertcat({HCP_aggr(:).Group})',groups(n)) & ~exclude_idx;
  ...
  saveas(figure(1),[work_folder '\Figs\Group' groups{n} 'Click heatmap.png']);
  close all
  ...
  set(gcf,'Position',get(0,'Screensize'));
  saveas(figure(1),[work_folder '\Figs\Group' groups{n} ' click change heatmap.png']);
  close all
  ...
  errorbar(mean(HCPsum.ITI_PunRate(incl_idx,:)*60,1),sem(HCPsum.ITI_PunRate(incl_idx,:)*60),...
    'k','CapSize',2);
  errorbar(mean(HCPsum.ITI_UnpRate(incl_idx,:)*60,1),sem(HCPsum.ITI_UnpRate(incl_idx,:)*60),...
    'k','CapSize',2);
  p1 = plot(mean(HCPsum.ITI_PunRate(incl_idx,:)*60,1),'Color',col_rep(2),'LineWidth',2);
  p2 = plot(mean(HCPsum.ITI_UnpRate(incl_idx,:)*60,1),'Color',col_rep(3),'LineWidth',2);
  xlabel('Block');
  ...
  incl_idx2 = incl_idx & ~isnan(HCPsum.PunTsuppr(:,2)) & ~isnan(HCPsum.UnpTsuppr(:,2));
  errorbar(mean(HCPsum.PunTsuppr(incl_idx2,:),1),sem(HCPsum.PunTsuppr(incl_idx2,:)),...
    'k.','CapSize',2);
  errorbar(mean(HCPsum.UnpTsuppr(incl_idx2,:),1),sem(HCPsum.UnpTsuppr(incl_idx2,:)),...
    'k.','CapSize',2);
  plot(HCPsum.PunTsuppr(incl_idx2,:)','Color',col_rep(2)+((1-col_rep(2)).*.5),'LineWidth',0.5);
  plot(HCPsum.UnpTsuppr(incl_idx2,:)','Color',col_rep(3)+((1-col_rep(3)).*.5),'LineWidth',0.5);
  p1 = plot(mean(HCPsum.PunTsuppr(incl_idx2,:),1),'Color',col_rep(2),'LineWidth',2);
  p2 = plot(mean(HCPsum.UnpTsuppr(incl_idx2,:),1),'Color',col_rep(3),'LineWidth',2);
  xlabel('Block');
  xlim([0.5 n_blocks+0.5]);
  xticks(1:n_blocks);
  plot(xlim,[0.5 0.5],'k:');
  ...
  plot(HCPsum.Pref(incl_idx,:)','Color',col_rep(14),'LineWidth',0.5);
  errorbar(mean(HCPsum.Pref(incl_idx,:),1),sem(HCPsum.Pref(incl_idx,:)),...
    'k.','CapSize',2);
  p1 = plot(mean(HCPsum.Pref(incl_idx,:),1),'k','LineWidth',1.5);
  incl_idx2 = incl_idx & ~any(isnan(HCPsum.PunS_suppr(:,[pun_blocks, pun2_blocks])),2);
  errorbar(mean(HCPsum.PunS_suppr(incl_idx2,:),1),sem(HCPsum.PunS_suppr(incl_idx2,:)),...
    'k.','CapSize',2);
  p2 = plot(mean(HCPsum.PunS_suppr(incl_idx2,:),1),'d--','Color',col_rep(2),'LineWidth',2,...
    'MarkerFaceColor',col_rep(2));
  incl_idx2 = incl_idx & ~any(isnan(HCPsum.UnpS_suppr(:,[pun_blocks, pun2_blocks])),2);
  errorbar(mean(HCPsum.UnpS_suppr(incl_idx2,:),1),sem(HCPsum.UnpS_suppr(incl_idx2,:)),...
    'k.','CapSize',2);
  p3 = plot(mean(HCPsum.UnpS_suppr(incl_idx2,:),1),'o--','Color',col_rep(3),'LineWidth',2,...
    'MarkerFaceColor',col_rep(3));
  incl_idx2 = incl_idx & ~any(isnan(HCPsum.pcPunShldTaken(:,[pun_blocks, pun2_blocks])),2);
  errorbar(mean(HCPsum.pcPunShldTaken(incl_idx2,:),1,'omitnan'),sem(HCPsum.pcPunShldTaken(incl_idx2,:)),...
    'k.','CapSize',2);
  p4 = plot(mean(HCPsum.pcPunShldTaken(incl_idx2,:),1,'omitnan'),'d-','Color',col_rep(1),'LineWidth',2,...
    'MarkerFaceColor',col_rep(2));
  incl_idx2 = incl_idx & ~any(isnan(HCPsum.pcUnpShldTaken(:,[pun_blocks, pun2_blocks])),2);
  errorbar(mean(HCPsum.pcUnpShldTaken(incl_idx2,:),1,'omitnan'),sem(HCPsum.pcUnpShldTaken(incl_idx2,:)),...
    'k.','CapSize',2);
  p5 = plot(mean(HCPsum.pcUnpShldTaken(incl_idx2,:),1,'omitnan'),'o-','Color',col_rep(1),'LineWidth',2,...
    'MarkerFaceColor',col_rep(3));
  xlabel('Block');
  xticks(1:n_blocks);
  xlim([0.5 n_blocks+0.5]);
  ...
  title('Values');
  errorbar(mean(HCPsum.PunPlanetVal(incl_idx,:),1),sem(HCPsum.PunPlanetVal(incl_idx,:)),...
    'k.','CapSize',2);
  errorbar(mean(HCPsum.UnpPlanetVal(incl_idx,:),1),sem(HCPsum.UnpPlanetVal(incl_idx,:)),...
    'k.','CapSize',2);
  errorbar(mean(HCPsum.PunShipVal(incl_idx,:),1),sem(HCPsum.PunShipVal(incl_idx,:)),...
    'k.','CapSize',2);
  errorbar(mean(HCPsum.UnpShipVal(incl_idx,:),1),sem(HCPsum.UnpShipVal(incl_idx,:)),...
    'k.','CapSize',2);
  errorbar(mean(HCPsum.RewVal(incl_idx,:),1),sem(HCPsum.RewVal(incl_idx,:)),...
    'k.','CapSize',2);
  errorbar(mean(HCPsum.AttackVal(incl_idx,:),1),sem(HCPsum.AttackVal(incl_idx,:)),...
    'k.','CapSize',2);
  p1 = plot(mean(HCPsum.PunPlanetVal(incl_idx,:),1),'Color',col_rep(2),'LineWidth',2);
  p2 = plot(mean(HCPsum.UnpPlanetVal(incl_idx,:),1),'Color',col_rep(3),'LineWidth',2);
  p3 = plot(mean(HCPsum.PunShipVal(incl_idx,:),1),'d--','Color',col_rep(2),'LineWidth',2,...
    'MarkerFaceColor',col_rep(2));
  p4 = plot(mean(HCPsum.UnpShipVal(incl_idx,:),1),'o--','Color',col_rep(3),'LineWidth',2,...
    'MarkerFaceColor',col_rep(3));
  p5 = plot(mean(HCPsum.RewVal(incl_idx,:),1),'k+:','LineWidth',1.5,'MarkerSize',10);
  p6 = plot(mean(HCPsum.AttackVal(incl_idx,:),1),'x-','Color',col_rep(2),'LineWidth',1.5,...
  ...
  title('Inferences');
  errorbar(mean(HCPsum.PunPlanet_RewInf(incl_idx,:),1),sem(HCPsum.PunPlanet_RewInf(incl_idx,:)),...
    'k.','CapSize',2);
  errorbar(mean(HCPsum.UnpPlanet_RewInf(incl_idx,:),1),sem(HCPsum.UnpPlanet_RewInf(incl_idx,:)),...
    'k.','CapSize',2);
  errorbar(mean(HCPsum.PunPlanet_PunShipInf(incl_idx,:),1),sem(HCPsum.PunPlanet_PunShipInf(incl_idx,:)),...
    'k.','CapSize',2);
  errorbar(mean(HCPsum.UnpPlanet_UnpShipInf(incl_idx,:),1),sem(HCPsum.UnpPlanet_UnpShipInf(incl_idx,:)),...
    'k.','CapSize',2);
  errorbar(mean(HCPsum.PunPlanet_UnpShipInf(incl_idx,:),1),sem(HCPsum.PunPlanet_UnpShipInf(incl_idx,:)),...
    'k.','CapSize',2);
  errorbar(mean(HCPsum.UnpPlanet_PunShipInf(incl_idx,:),1),sem(HCPsum.UnpPlanet_PunShipInf(incl_idx,:)),...
    'k.','CapSize',2);
  errorbar(mean(HCPsum.PunShip_AttackInf(incl_idx,:),1),sem(HCPsum.PunShip_AttackInf(incl_idx,:)),...
    'k.','CapSize',2);
  errorbar(mean(HCPsum.UnpShip_AttackInf(incl_idx,:),1),sem(HCPsum.UnpShip_AttackInf(incl_idx,:)),...
    'k.','CapSize',2);
  errorbar(mean(HCPsum.PunPlanet_AttackInf(incl_idx,:),1),sem(HCPsum.PunPlanet_AttackInf(incl_idx,:)),...
    'k.','CapSize',2);
  errorbar(mean(HCPsum.UnpPlanet_AttackInf(incl_idx,:),1),sem(HCPsum.UnpPlanet_AttackInf(incl_idx,:)),...
    'k.','CapSize',2);
  p1 = plot(mean(HCPsum.PunPlanet_RewInf(incl_idx,:),1),'+:','Color',col_rep(2),...
    'LineWidth',1.5,'MarkerSize',10);
  p2 = plot(mean(HCPsum.UnpPlanet_RewInf(incl_idx,:),1),'+:','Color',col_rep(3),...
    'LineWidth',1.5,'MarkerSize',10);
  p3 = plot(mean(HCPsum.PunPlanet_PunShipInf(incl_idx,:),1),'d--','Color',col_rep(2),...
    'LineWidth',2,'MarkerFaceColor',col_rep(2));
  p9 = plot(mean(HCPsum.PunPlanet_UnpShipInf(incl_idx,:),1),'o--','Color',col_rep(2),...
    'LineWidth',2,'MarkerFaceColor',col_rep(3));
  p4 = plot(mean(HCPsum.UnpPlanet_UnpShipInf(incl_idx,:),1),'o--','Color',col_rep(3),...
    'LineWidth',2,'MarkerFaceColor',col_rep(3));
  p10 = plot(mean(HCPsum.UnpPlanet_PunShipInf(incl_idx,:),1),'d--','Color',col_rep(3),...
    'LineWidth',2,'MarkerFaceColor',col_rep(2));
  p5 = plot(mean(HCPsum.PunShip_AttackInf(incl_idx,:),1),'x--','Color',col_rep(2),...
    'LineWidth',1.5,'MarkerSize',10);
  p6 = plot(mean(HCPsum.UnpShip_AttackInf(incl_idx,:),1),'x--','Color',col_rep(3),...
    'LineWidth',1.5,'MarkerSize',10);
  p7 = plot(mean(HCPsum.PunPlanet_AttackInf(incl_idx,:),1),'x:','Color',col_rep(2),...
    'LineWidth',1.5,'MarkerSize',10);
  p8 = plot(mean(HCPsum.UnpPlanet_AttackInf(incl_idx,:),1),'x:','Color',col_rep(3),...
    'LineWidth',1.5,'MarkerSize',10);
  xlabel('Block');
  xlim([0.5 n_blocks+0.5]);
  xticks(1:n_blocks);
  ...
  title('Confidence');
  errorbar(mean(HCPsum.PunPlanet_RewInfconf(incl_idx,:),1),sem(HCPsum.PunPlanet_RewInfconf(incl_idx,:)),...
    'k.','CapSize',2);
  errorbar(mean(HCPsum.UnpPlanet_RewInfconf(incl_idx,:),1),sem(HCPsum.UnpPlanet_RewInfconf(incl_idx,:)),...
    'k.','CapSize',2);
  errorbar(mean(HCPsum.PunPlanet_PunShipInfconf(incl_idx,:),1),sem(HCPsum.PunPlanet_PunShipInfconf(incl_idx,:)),...
    'k.','CapSize',2);
  errorbar(mean(HCPsum.UnpPlanet_UnpShipInfconf(incl_idx,:),1),sem(HCPsum.UnpPlanet_UnpShipInfconf(incl_idx,:)),...
    'k.','CapSize',2);
  errorbar(mean(HCPsum.PunShip_AttackInfconf(incl_idx,:),1),sem(HCPsum.PunShip_AttackInfconf(incl_idx,:)),...
    'k.','CapSize',2);
  errorbar(mean(HCPsum.UnpShip_AttackInfconf(incl_idx,:),1),sem(HCPsum.UnpShip_AttackInfconf(incl_idx,:)),...
    'k.','CapSize',2);
  errorbar(mean(HCPsum.PunPlanet_AttackInfconf(incl_idx,:),1),sem(HCPsum.PunPlanet_AttackInfconf(incl_idx,:)),...
    'k.','CapSize',2);
  errorbar(mean(HCPsum.UnpPlanet_AttackInfconf(incl_idx,:),1),sem(HCPsum.UnpPlanet_AttackInfconf(incl_idx,:)),...
    'k.','CapSize',2);
  p1 = plot(mean(HCPsum.PunPlanet_RewInfconf(incl_idx,:),1),'+:','Color',col_rep(2),...
    'LineWidth',1.5,'MarkerSize',10);
  p2 = plot(mean(HCPsum.UnpPlanet_RewInfconf(incl_idx,:),1),'+:','Color',col_rep(3),...
    'LineWidth',1.5,'MarkerSize',10);
  p3 = plot(mean(HCPsum.PunPlanet_PunShipInfconf(incl_idx,:),1),'d--','Color',col_rep(2),...
    'LineWidth',2,'MarkerFaceColor',col_rep(2));
  p4 = plot(mean(HCPsum.UnpPlanet_UnpShipInfconf(incl_idx,:),1),'o--','Color',col_rep(3),...
    'LineWidth',2,'MarkerFaceColor',col_rep(3));
  p5 = plot(mean(HCPsum.PunShip_AttackInfconf(incl_idx,:),1),'x--','Color',col_rep(2),...
    'LineWidth',1.5,'MarkerSize',10);
  p6 = plot(mean(HCPsum.UnpShip_AttackInfconf(incl_idx,:),1),'x--','Color',col_rep(3),...
    'LineWidth',1.5,'MarkerSize',10);
  p7 = plot(mean(HCPsum.PunPlanet_AttackInfconf(incl_idx,:),1),'x:','Color',col_rep(2),...
    'LineWidth',1.5,'MarkerSize',10);
  p8 = plot(mean(HCPsum.UnpPlanet_AttackInfconf(incl_idx,:),1),'x:','Color',col_rep(3),...
    'LineWidth',1.5,'MarkerSize',10);
  xlabel('Block');
  xlim([0.5 n_blocks+0.5]);
  xticks(1:n_blocks);
  ...
  set(gcf,'Position',get(0,'Screensize'));
  saveas(figure(1),[work_folder '\Figs\Group' groups{n} ' Aggregate summary.png']);
  close all
end
